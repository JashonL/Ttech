package com.tianji.ttech.monitor
...
class WifiMonitor :BroadcastReceiver(),LifecycleObserver{
    ...
    companion object {
        ...
        fun watch(
            ...
            LocalBroadcastManager.getInstance(TtechApplication.instance())
    ...
    fun unWatch() {
        listener = null
        LocalBroadcastManager.getInstance(TtechApplication.instance()).unregisterReceiver(this)
    }
}